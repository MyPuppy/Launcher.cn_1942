    ...
    public class StartGameData
    {
        ...
        public static void PrStartTimeAttack()
        {
            using (OutPacket oPacket = new OutPacket("PrStartTimeAttack"))
            {
                ...
                oPacket.WriteFloat(Kart.AirFriction);
                oPacket.WriteFloat(SpeedType.DragFactor + Kart.DragFactor + FlyingPet.DragFactor + SpeedPatch.DragFactor);
                oPacket.WriteFloat(SpeedType.ForwardAccelForce + Kart.ForwardAccelForce + FlyingPet.ForwardAccelForce + TuneSpec.Plant_ForwardAccelForce + TuneSpec.KartLevel_ForwardAccelForce + SpeedPatch.ForwardAccelForce);
                oPacket.WriteFloat(SpeedType.BackwardAccelForce + Kart.BackwardAccelForce);
        ...
        public static void PrKartSpec()
        {
            using (OutPacket oPacket = new OutPacket("PrKartSpec"))
            {
                ...
                oPacket.WriteFloat(Kart.AirFriction);
                oPacket.WriteFloat(SpeedType.DragFactor + Kart.DragFactor + FlyingPet.DragFactor + SpeedPatch.DragFactor);
                oPacket.WriteFloat(SpeedType.ForwardAccelForce + Kart.ForwardAccelForce + FlyingPet.ForwardAccelForce + SpeedPatch.ForwardAccelForce);
                oPacket.WriteFloat(SpeedType.BackwardAccelForce + Kart.BackwardAccelForce);
